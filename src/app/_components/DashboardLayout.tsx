...
export function DashboardLayout({ children, activeSection = 'dashboard' }: DashboardLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-[#0A0A0B] overflow-hidden">
      ...
      <aside
        className={cn(
          'bg-[#14161B] border-r border-[rgba(255,255,255,0.08)] transition-all duration-300 flex flex-col',
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {showBadge && (
                  <span className="w-5 h-5 rounded-full bg-[#FF2D2D] text-white text-xs font-bold flex items-center justify-center flex-shrink-0">
